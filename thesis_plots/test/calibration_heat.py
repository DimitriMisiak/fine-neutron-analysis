...
h5_path = '/home/misiak/Analysis/RED80/{}/data_ion_calib.h5'.format(stream)
selection_path = '/home/misiak/Analysis/RED80/{0}/{0}_10kev_selection.npy'.format(stream)
